...
def fig_data_scaling():
    ...
    # Empirical 250M point — same warm-started NT-Genus series as v4/v8/v9
    # (kept out of the 3-point fit). It falls well below the log-linear
...
def fig_rc_tta():
    exps   = ["v3\n500K", "v4\n500K", "v5b\n500K\nLA", "v7\n500K\nRC-cons.",
              ...
              "DNABERT\n5M", "DNABERT-2\n5M",
              "v11\n50M\n(shallow)"]
    fwd    = [53.92, 53.75, 52.29, 54.10, 62.02, 66.29,
              61.20, 57.35,
              53.80]
    rc_tta = [55.36, 55.29, 53.58, 55.18, 63.05, 67.07,
              61.78, 58.88,
              53.88]
